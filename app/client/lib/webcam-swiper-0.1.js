...
Swiper = (function() {
    ...
    var videoElement, eventAnchor;

    function initializeWebcamSwiper(_eventAnchor) {
        ...
        if (_eventAnchor === undefined) {
            eventAnchor = document.getElementsByTagName("body")[0];
        } else {
            eventAnchor = _eventAnchor;
        }
    ...
    function startSwipeRecogntion() {
        ...
        function fireSwipeEvent(eventName) {
            ...
            eventAnchor.dispatchEvent(swipeEvent);
        }
